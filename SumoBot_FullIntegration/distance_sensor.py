...
#TODO These pins have been reserved for another function, import pins from constants?
...
#TODO Function needs to return True when somethere is detected too close
def check_distance():
...
#TODO wrap this in a if __name__ 
while True:
    check_distance()
